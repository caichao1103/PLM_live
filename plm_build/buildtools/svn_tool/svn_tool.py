...
def is_link(file_path):
    ...
    :return:
    """
    #  or platform.platform() == 'Windows-10-10.0.16299'
    if platform.platform() == 'Windows-7-6.1.7601-SP1' or os.environ.get('NODE_NAME') == 'xj4-163.166' or os.environ.get('NODE_NAME') == 'xj4-86.55' :
        cmd = ['dir', file_path.replace('/', '\\')]
        result = check_output(cmd, shell=True)
        return '<SYMLINK>' in result
